...
@section('jumbotron')
    @include('partials.jumbotron', ['title' => __('Marcas'), 'icon' => 'edit'])
@endsection
      ...
      <tbody>
        @foreach($brands as $brandData)
          <tr>
            ...
            <td>{{$brandData->description}}</td>
            <td>
                <a href="#" class="btn btn-success edit"> {{__("Editar")}}   </a>
                <a href="#" class="btn btn-danger delete"> {{__("Eliminar")}}</a>
                <!--<form action="{{action('BrandController@destroy', $brandData->id)}}" method="POST">
                  {{csrf_field()}}
                  {{method_field('DELETE')}}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">{{__("Marca")}}</h5>
      ...
      @csrf
        <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="bName" class="form-control" placeholder={{__("Ingrese el nombre")}}>
            </div>
            <div class="form-group">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/brand" method="POST" id="editForm">
      {{csrf_field()}}
      {{method_field('PUT')}}
        <div class="modal-body">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="/brand" method="POST" id="deleteForm">
      {{csrf_field()}}
      {{method_field('DELETE')}}
        <div class="modal-body">
          <input type="hidden" name="_method" value="DELETE">
...
<script type="application/javascript">
  $(document).ready(function (){
    ...
    table.on('click','.edit',function(){
      ...
      $('#editForm').attr('action','/brand/'+data[0]);
    ...
    table.on('click','.delete',function(){
      ...
      $('#deleteForm').attr('action','/brand/'+data[0]);
